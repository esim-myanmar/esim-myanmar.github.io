  ...
  const sections = [
    ...
    },
    {
      ...
      content: t(
        ...
        "ကျွန်ုပ်တို့၏ ဝန်ဆောင်မှုများနှင့် ၎င်းတို့၏ အကြောင်းအရာ၊ အင်္ဂါရပ်များနှင့် လုပ်ဆောင်နိုင်စွမ်းအားလုံး (အချက်အလက်၊ ဆော့ဖ်ဝဲလ်၊ စာသား၊ ပြသမှုများ၊ ပုံရိပ်များ၊ ဗီဒီယိုနှင့် အသံ၊ ထို့အပြင် ၎င်းတို့၏ ဒီဇိုင်း၊ ရွေးချယ်မှုနှင့် စီစဉ်မှုအားလုံး အပါအဝင်သော်လည်း ကန့်သတ်မထားပါ။",
      ),
    },
    {
        ...
        <div className="py-8 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#263A49] to-[#1E2F3C] p-8 rounded-xl border border-[#00FFFF]/10 shadow-lg mb-12">
            <p className="text-[#B0BEC5] mb-6">
              <LocalizedText
                ...
                mm="eSIM Myanmar ('ကျွန်ုပ်တို့'၊ 'ကျွန်ုပ်တို့၏' သို့မဟုတ် 'ကျွန်ုပ်တို့ကို') မှ လုပ်ဆောင်သော eSIM Myanmar ဝဘ်ဆိုဒ်၊ မိုဘိုင်းအပ်ပလီကေးရှင်းများနှင့် ဝန်ဆောင်မှုများ (စုပေါင်း၍ 'ဝန်ဆောင်မှုများ') ကို သေချာစွာ ဖတ်ရှုပါ။"
              />
            </p>
          ...
          <div className="mt-12 bg-gradient-to-br from-[#263A49] to-[#1E2F3C] p-8 rounded-xl border border-[#00FFFF]/10 shadow-lg">
            ...
            <ul className="text-[#B0BEC5] space-y-2">
              ...
              <li>
                <LocalizedText en="Phone: +95 965 0000172" mm="ဖုန်း: +95 965 0000172" />
              </li>
              <li>
                <LocalizedText en="Website: www.esim.com.mm" mm="ဝဘ်ဆိုဒ်: www.esim.com.mm" />
              </li>
              <li>
                <LocalizedText
                  en="Address: Parami Road, No-70/A, Ward (16), Hlaing Township, Yangon, Myanmar"
                  mm="လိပ်စာ: ပါရမီလမ်း၊ အမှတ် ၇၀/A၊ ရပ်ကွက် (၁၆)၊ လှိုင်မြို့နယ်၊ ရန်ကုန်၊ မြန်မာ"
                />
              </li>
            </ul>
          </div>
